...
const addNewNote = (txt = '') => {
    ...
    const classes = ['note','h-52','p-2','bg-yellow-100','rounded','flex','flex-col','shadow-lg','border-b-4','border-yellow-400'];
    ...
    const htmlData = `
        ...
        <div class="noteTxt p-1 overflow-y-auto pb-4 text-black ${txt ? "" : "hidden" }"></div>
